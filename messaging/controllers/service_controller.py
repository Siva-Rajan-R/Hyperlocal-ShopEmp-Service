...
from ..msgqueue_services.shop_msgqueue_services import MessagingQueueShopService
from ..msgqueue_services.emp_msgqueue_services import MessagingQueueEmployeeService


MESSAGING_QUEUE_SERVICE_MAPPER_BY_SERVICE_NAME={
    "SHOPS": MessagingQueueShopService,
    "EMPLOYEES":MessagingQueueEmployeeService
}
